...
// import SearchFilter from "../shearedComponents/SearchFilter";
import SearchFilterInner from "../shearedComponents/SearchFilterInner";
import LineDashIcon from "@/svg/LineDashIcon";
    ...
    <>
      <section className="bd-cta-area">
        <div className="container">
          <div className="row">
            <div className="col-xl-12">
              <div className="cta-wrapper cta-item cta-top p-relative">
                <div className="cta-five-shape-wrap"></div>
                <SearchFilterInner bgClass="banner-search-box has-bg" />
              </div>
            </div>
          </div>
        </div>
