...
import TourDetailsLeftTabArea from "./TourDetailsLeftTabArea";
...
const TourDetailsLeft = () => {
  const tourDetailsLeftData = tourData && tourData.slice(40, 42);
  return (
    <>
        ...
        <div className="container">
          <div className="row gy-24">
            <div className="col-xxl-4 col-xl-4 col-lg-5 order-lg-0 order-1">
              <SidebarSearchArea placeHolderTextData="Tour" />
            </div>
