...
const DayUseRoomSearch = () => {
    ...
    return (
        <section className="saltstayz-search-section ss-search">
            <div className="container">
                <div className="saltstayz-search-box">
                    ...
                    <div className="saltstayz-search-field hotel-select adult-dropdown">
                        <div className="saltstayz-select-wrapper input-grp">
                            <label htmlFor="adultSelect" className="form-label"> Adult</label>
                            <select
                                id="adultSelect"
                                className="saltstayz-select select-input"
                    ...
                    {/* <div className="saltstayz-flash-btn">
                        <div className="saltstayz-flash-icon">
                            <img src="/index/saltstays.svg" alt="Flash" width={32} height={32} />
                        </div>
...
export default DayUseRoomSearch;