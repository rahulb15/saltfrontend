...
export const faqData: IFaqInterface[] = [
  ...
  },
  {
    ...
    answer:
      "We understand that plans can change, which is why we offer flexible cancellation and modification policies for our tours and services. Depending on the terms and conditions of your reservation, you may be eligible for a full or partial refund, or the option to reschedule your booking for a later date. Please refer to our cancellation policy or contact our customer service team for assistance with any changes to your reservation.",
    id: "Eight",
  },
  {
...
export const indexFaqData: IFaqInterface[] = [
  ...
  {
    question: "Can I get free support?",
    answer:
      "We believe in fostering trust and building strong relationships with our customers. Providing complimentary support is our commitment to demonstrating that we stand behind our products and are dedicated to assisting you every step of the way on your journey with us.",
    id: "Twelve",
  },
  {
    question: "Can I change any Elements as I like?",
    answer:
      "You can customize elements as you like, but some limitations may apply to maintain functionality and integrity. Our goal is to provide flexibility to meet your needs.",
    id: "Thirteen",
  },
  {
    question: "Do you have an online documentation?",
    answer:
      "Yes, you can find our online documentation on our website under the 'Documentation'  or 'Help Center' section. It's user-friendly and organized for easy access to setup instructions, tutorials, and  troubleshooting guides.",
    id: "Fourteen",
  },
  {
    question: "Can I build a complete project with this template?",
    answer:
      "Yes, you can customize all elements to your liking and build your chosen website with ease.",
    id: "Fifteen",
  },
];
//index faq data end
...
export const faqElementStyle1: IFaqInterface[] = [
  {
    question: "What should I pack for my trip?",
    answer:
      "Create comprehensive packing lists tailored to different types of trips (e.g., beach vacation, hiking adventure, city exploration).",
    id: "one",
  },
  {
    question: "How do I find the best deals on flights and accommodations?",
    answer:
      "Share strategies for booking flights and accommodations at the lowest prices, such as using fare comparison websites, booking in advance, and being flexible with travel dates.",
    id: "two",
  },
  {
    question: "What are some tips for staying safe while traveling abroad?",
    answer:
      "Discuss common safety precautions, such as avoiding unsafe areas, securing valuables, and staying vigilant in crowded places.",
    id: "three",
  },
];
export const faqElementStyle2: IFaqInterface[] = [
  {
    question: "What should I pack for my trip?",
    answer:
      "Create comprehensive packing lists tailored to different types of trips (e.g., beach vacation, hiking adventure, city exploration).",
...
export const faqElementStyle3: IFaqInterface[] = [
  {
    question: "What should I pack for my trip?",
    answer:
      "Create comprehensive packing lists tailored to different types of trips (e.g., beach vacation, hiking adventure, city exploration).",
...
export const faqElementStyle4: IFaqInterface[] = [
  {
    question: "What should I pack for my trip?",
    answer:
      "Create comprehensive packing lists tailored to different types of trips (e.g., beach vacation, hiking adventure, city exploration).",
...
export const faqElementStyle5: IFaqInterface[] = [
  {
    question: "What should I pack for my trip?",
    answer:
      "Create comprehensive packing lists tailored to different types of trips (e.g., beach vacation, hiking adventure, city exploration).",
...
export const faqElementStyle6: IFaqInterface[] = [
  {
    question: "What should I pack for my trip?",
    answer:
      "Create comprehensive packing lists tailored to different types of trips (e.g., beach vacation, hiking adventure, city exploration).",
...
export const faqElementStyle7: IFaqInterface[] = [
  {
    question: "What should I pack for my trip?",
    answer:
      "Create comprehensive packing lists tailored to different types of trips (e.g., beach vacation, hiking adventure, city exploration).",
